...
export default function ManageRoomsClient() {
    // Use client-side query instead of preloaded query
    // rooms will be undefined while loading, null if not authenticated, or array of rooms
